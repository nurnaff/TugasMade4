...
public class NewPlayingActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<MovieItems>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_playing);
    ...
    public Loader<ArrayList<MovieItems>> onCreateLoader(int id, Bundle args) {
        return new MyAsynTaskLoader(this,"https://api.themoviedb.org/3/movie/now_playing?api_key=6c063cdb5fc9520684745b5408008e68&language=en-US");
    }
